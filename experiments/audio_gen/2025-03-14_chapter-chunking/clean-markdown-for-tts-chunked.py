...
MIN_CHUNK_SIZE = 500  # Minimum characters for a chunk to be considered valid - reduced for testing
...
try:
    ...
    print(f"Split {len(chapters)} chapters from {test_file.name} into {total_chunks} total chunks")
