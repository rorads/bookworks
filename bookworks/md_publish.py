...
""",
    ...
    parser.add_argument(
        "--author", default="Author Not Specified", help="Author name for EPUB metadata"
    )
    parser.add_argument(
        "--debug", action="store_true", help="Keep the processed markdown file"
    )
    parser.add_argument(
    ...
    output_file, error = process_markdown_file(
        args.input_file, args.author, args.debug, not args.no_toc
    )
    if error:
